        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0"> with T E S L A </p>
                </div>
            </div>
        </header>
        <!-- Section-->
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
				...
				if ($result->num_rows > 0)
				{
					...
					{
						$dcatid =  $row['catid'];
                        $dname=$row['productName'];
                        $dprice = $row['productPrice'];
                        $dimg = $row['productImage'];
                        $status =$row['status'];
                        $id = $row['id'];
                ...
                <div class="col mb-5">
                        ...
                        <div class="card h-100">
                            <!-- Product image-->
                                ...
                                <img class="card-img-top" src="/flipkart/ADMIN/uploads/<?php echo $dimg ?>"/>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"><?php echo $dname ?></h5>
                                    <!-- Product price-->
                                    $<?php echo  $dprice ?>
                                </div>
                            </div>
