                ...
                <div class="col mb-5">             
                        <div class="card h-100">
                            <!-- Product image-->
                                ...
                                <img class="card-img-top" src="/projectX/img/Hampi.jpg"/>
                            <!-- Product details-->
                    ...
                    <div class="col mb-5">             
                        <div class="card h-100">
                            <!-- Product image-->
                                ...
                                <img class="card-img-top" src="/projectX/img/goa.webp"/>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                       ...
                       <div class="col mb-5">             
                        <div class="card h-100">
                            <!-- Product image-->
                                ...
                                <img class="card-img-top" src="/projectX/img/3r.jpg">
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                   ...
                   <div class="col mb-5">             
                        <div class="card h-100">
                            <!-- Product image-->
                                ...
                                <img class="card-img-top" src="/projectX/img/udupi.jpg"/>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
